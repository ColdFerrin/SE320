...
procedure Main is
   ...
   Temp_Celcius_1,
   Temp_Celcius_2,
   Temp_Celcius_3: Temperature.Fahrenheit_Type;
begin
   ...
   Ada.Float_Text_IO.put(Float(Temp_Kelvin_1));
   Ada.Text_IO.put("K is ");
   Ada.Float_Text_IO.put(Float(Temp_Celcius_1));
   Ada.Text_IO.put(" deg C and ");
   Ada.Float_Text_IO.put(Float (Temp_Fahrenheit_1));
   ...
   Ada.Float_Text_IO.put(Float(Temp_Celcius_2));
   Ada.Text_IO.put("deg C is ");
   Ada.Float_Text_IO.put(Float(Temp_Kelvin_2));
   Ada.Text_IO.put(" K and ");
   Ada.Float_Text_IO.put(Float(Temp_Fahrenheit_2));
   Ada.Text_IO.put(" deg F ");
   Ada.Text_IO.New_Line;
   ...
   Ada.Float_Text_IO.put(Float(Temp_Fahrenheit_3));
   Ada.Text_IO.put("deg F is ");
   Ada.Float_Text_IO.put(Float(Temp_Celcius_3));
   Ada.Text_IO.put(" deg C and ");
   Ada.Float_Text_IO.put(Float(Temp_Fahrenheit_3));
   Ada.Text_IO.put(" k ");
   Ada.Text_Io.New_Line;
